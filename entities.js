...
class Shade extends Player {
  constructor(pos, speed) {
    ...
    this.firstTime=0;
    this.secondTime=0;
    this.hasAB = true; this.ab1 = night; this.ab2 = vengeance; this.ab1L = 5; this.ab2L = 0; this.firstTotalCooldown = 7000; this.secondTotalCooldown = 1000;
  }
  abilities(time, area, offset) {
    if (this.firstAbility) {
      this.firstAbilityActivated = !this.firstAbilityActivated;
      if(this.energy>=30&&this.firstAbilityCooldown==0){
        ...
        this.night = true;
        setTimeout(()=>{this.speedAdditioner=0;this.night=false;this.invicible=false;},7000)
      }
    }
    if (this.secondAbility) {
      this.secondAbilityActivated = !this.secondAbilityActivated;
